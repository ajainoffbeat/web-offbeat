      ...
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        <div className="flex w-full items-center justify-between xl:w-1/4">
          <Link to="/">
            <img
              ...
              alt="logo"
              width={119}
              className="transform scale-[3] h-[40px]"
            />
          </Link>
        ...
        >
                ...
                <li key={key} className={menuItem.submenu && "group relative"}>
                  {menuItem.submenu ? (
                    ...
                    <NavLink
                      to={`${menuItem.path}`}
                      className={`${
                        scrollHeight < 71 && pathUrl === `/` && !navigationOpen
                          ? "text-white"
          ...
          <div className="mt-7 flex items-center gap-6 xl:mt-0">
            ...
            {/* <NavLink
              to="#"
              className="relative flex items-center justify-center rounded-full bg-primary px-7.5 py-2.5 text-regular text-white duration-300 ease-in-out overflow-hidden group"
            >
